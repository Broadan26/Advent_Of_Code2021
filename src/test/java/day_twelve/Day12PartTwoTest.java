...
class Day12PartTwoTest {
    ...
    void testFileInputSmall() {
        Day12PartTwo day12PartTwo = new Day12PartTwo(basePath + "\\Input\\input_day_12_small");
    ...
    void testFileInputMedium() {
        Day12PartTwo day12PartTwo = new Day12PartTwo(basePath + "\\Input\\input_day_12_medium");
    ...
    void testFileInputLarge() {
        Day12PartTwo day12PartTwo = new Day12PartTwo(basePath + "\\Input\\input_day_12_large");
