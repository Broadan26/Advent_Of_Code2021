...
public class Day2PartTwo {
    ...
    public Day2PartTwo() {
        ...
        logger = LoggerFactory.getLogger(Day2PartTwo.class);
    }

    public Day2PartTwo(String filePath) {
     ...
     * Assumes the object starts at horizontal position 0, depth 0, aim 0.
     *
        ...
        if (!directionsList.isEmpty()) {
            for (Direction direction : directionsList) {
                switch (direction.getDirection()) {
                    case "forward":
                        horizontal += direction.getDegree();
                        depth += (aim*direction.getDegree());
                        break;
                    case "up":
                        aim -= direction.getDegree();
                        break;
                    case "down":
                        aim += direction.getDegree();
                        break;
