...
public class Day5PartOne {
    ...
    public Day5PartOne() {
        ...
        logger = LoggerFactory.getLogger(Day5PartOne.class);
    }

    public Day5PartOne(String filePath) {
        ...
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                if (line.length() != 0) {
                    ...
                    // Parse the input
                    Pair<Integer, Integer>[] fill = parseLine(line);

                    // Ensure parsed input meets requirements before adding
                    if (Objects.equals(fill[0].getValue0(), fill[1].getValue0()) ||
                            Objects.equals(fill[0].getValue1(), fill[1].getValue1())) {
                        pointsList.add(fill);
                    }
                }
            }
